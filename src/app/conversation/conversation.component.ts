...
export class ConversationComponent implements OnInit {
  ...
  conversations: any[] = [{
    ...
    {
      message: 'Identifying path to Senior Ball Room, from North Entrance of CLUB.',
      isVisible: false,
      isSent: false
    },
    {
    ...
    {
      message: 'Alright make a right turn to the elevator. Say "go" when you leave the elevator',
      isVisible: false,
      isSent: false
    },
    {
